...
from evaluation import evaluate_ranking, evaluate_train
...
if __name__ == '__main__':
    ...
    # data arguments
    # parser.add_argument('--train_root', type=str, default='/content/drive/MyDrive/MIA/Recommender/caser_pytorch-master/datasets/ml-1m_Smember_train')
    # parser.add_argument('--test_root', type=str, default='/content/drive/MyDrive/MIA/Recommender/caser_pytorch-master/datasets/ml-1m_Smember_test')
    # parser.add_argument('--train_root', type=str, default='/content/drive/MyDrive/MIA/Recommender/caser_pytorch-master/datasets/beauty_Smember_train')
    # parser.add_argument('--test_root', type=str, default='/content/drive/MyDrive/MIA/Recommender/caser_pytorch-master/datasets/beauty_Smember_test')
    parser.add_argument('--train_root', type=str, default='/content/drive/MyDrive/MIA/Recommender/caser_pytorch-master/datasets/book_Smember_train')
    parser.add_argument('--test_root', type=str, default='/content/drive/MyDrive/MIA/Recommender/caser_pytorch-master/datasets/book_Smember_test')
    ...
    # print("usermap:", model_config.usermap)
    # print("itemmap:", model_config.itemmap)
