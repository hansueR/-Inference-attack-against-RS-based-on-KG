...
def evaluate_train(model, test, train=None):
    ...
    test = test.tocsr()
    # ml-1m
    # fw = open("/content/drive/MyDrive/DL-MIA-KDD-2022/DL-MIA-SR/Recommender/caser_pytorch-master/datasets/ml-1m_Smember_recommendations", 'w')
    # beauty
    # fw = open("/content/drive/MyDrive/DL-MIA-KDD-2022/DL-MIA-SR/Recommender/caser_pytorch-master/datasets/beauty_Smember_recommendations", 'w')
    # book
    fw = open("/content/drive/MyDrive/DL-MIA-KDD-2022/DL-MIA-SR/Recommender/caser_pytorch-master/datasets/book_Smember_recommendations", 'w')
    ...
    for user_id, row in enumerate(test):
        ...
        recommend_items = [model.itemmap.get(x+1, None) for x in topk_predictions]
