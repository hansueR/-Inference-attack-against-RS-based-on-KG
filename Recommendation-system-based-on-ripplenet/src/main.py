...
parser.add_argument('--model_dir', type=str, default='/content/drive/MyDrive/Recommendation-system-based-on-ripplenet/model', help='directory to save model')
parser.add_argument('--use_cuda', type=bool, default=True, help='whether to use gpu')
parser.add_argument('--k', type=int, default=100, help='number of top_k')
